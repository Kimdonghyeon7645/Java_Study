public class note03_1 {
    public static void main(String[] args) {
        ...
        System.out.println(1 << 1); // a << b   : a를 왼쪽으로 b만큼 쉬프트 연산
        System.out.println(2 >> 1); // a >> b   : a를 오른쪽으로 b만큼 쉬프트 연산 (비는 공간 최상위 부호 비트로 채움)
        System.out.println(2 >>> 1);    // a >>> b   : a를 오른쪽으로 b만큼 쉬프트 연산 (비는 공간 0으로 채움)

        /*
        대입 연산자 : 오른쪽 피연산자(값, 변수)을 왼쪽 피연산자(변수)에 대입하는 연산자
        단순대입 연산자 : ==
        복합대입 연산자 : +=, -=, *=, /=, %=, 7=, |=, ^=, <<=, >>=, >>>=
         */
        ...
        /*
        삼항 연산자(?:) : [조건식] ? [참일 때 값 또는 연산식] : [거짓일 때 값 또는 연산식]
         */
    }
}
